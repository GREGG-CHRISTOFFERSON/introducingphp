...
<?php include './_includes/header.html'; ?>
  ...
  <section id="main">
    ...
    <article id="featuredartists">
      ...
      <div class="artistgroup clearfix">
        <ul class="clearfix">
          <?php include './_includes/featured-artist.html'; ?>
        </ul>
        <p class="clearfix"><a class="link" href="<?= $siteroot ?>/artists.php">View Artist Info</a></p>
      </div>
    </article>
    <!-- Featured Artists -->
    <article id="thevenue">
  ...
  <aside id="sidebar" class="clearfix">
    <?php include './_includes/mobile-site.html'; ?>
    <!-- Coming to event -->
